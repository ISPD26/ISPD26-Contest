...
set def_file ${top_proj_dir}/solution/output/${design_name}/${folder}/${design_name}.def
set verilog_netlist ${top_proj_dir}/solution/output/${design_name}/${folder}/${design_name}.v
